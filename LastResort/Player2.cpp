...
{
	return (App->input->keyboard[SDL_SCANCODE_DOWN] == KEY_STATE::KEY_REPEAT || SDL_GameControllerGetAxis(App->input->controller[1], SDL_CONTROLLER_AXIS_LEFTY)>10000);
}
...
bool Player2::Shoot()
{
	return (App->input->keyboard[SDL_SCANCODE_KP_0] == KEY_STATE::KEY_DOWN || SDL_GameControllerGetButton(App->input->controller[1], SDL_CONTROLLER_BUTTON_B));
}
