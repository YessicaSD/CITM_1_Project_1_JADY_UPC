...
Enemy_PowerDropper::Enemy_PowerDropper(int x, int y, POWERUP_TYPE pu_t) : Enemy(x, y,  pu_t)
{
	...
	collider = App->collision->AddCollider({ x, y, 32, 26 }, COLLIDER_TYPE::COLLIDER_ENEMY, (Module*)App->enemies);
	original_y = y;
}
