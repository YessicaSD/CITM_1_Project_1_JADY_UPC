...
bool ModuleWindow::Init()
{
	...
	else
	{
		...
		window = SDL_CreateWindow("Last Resort - Team JADY", SDL_WINDOWPOS_UNDEFINED, SDL_WINDOWPOS_UNDEFINED, SCREEN_WIDTH*SCREEN_SIZE, SCREEN_HEIGHT*SCREEN_SIZE, flags);
