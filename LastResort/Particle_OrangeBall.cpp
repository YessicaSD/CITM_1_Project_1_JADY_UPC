...
Particle_OrangeBall::Particle_OrangeBall(Particle& p, iPoint position, Uint32 delay, COLLIDER_TYPE colType, SDL_Texture* tex) : Particle(p, position, delay, colType, tex)
{
